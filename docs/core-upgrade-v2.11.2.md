...
This migration updates `obsidian-tools` from the published `git-starter-kit` v2.7.0
...
- Preserve the sole published commit exception `bde6a089e940b49ce1e4eaaf121bdbb23825ffec` in range linting.
  Environment variables cannot add exceptions; later invalid commits still fail.
...
| `tools/repository-audit/profiles.sh` | Preserve the sole immutable published-commit exception and strict error propagation. |
